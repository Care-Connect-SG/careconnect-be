...
async def generate_ai_report(
    ...
    """
    Generate an AI-powered wellness report for a resident based on their medical history and past reports.
    """
    try:
        ...
        return await create_wellness_report(db, resident_id, ai_suggestion)
